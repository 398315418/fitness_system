...
<body>
<form action="user.do?method=selYy" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">预约单管理</a></li>
		<li><a href="#">预约单信息查询</a></li>
	</ul>
</div>
...
<!--             </div></a> -->
				...
				<td>${list.date}</td>
				<td>
				<a href = "user.do?method=deleteYy&id=${list.id}" onclick="toAdd()"><font color="blue">删除预约单</font></a>
				</td>
			</tr>
			</c:forEach>
		</c:if>
