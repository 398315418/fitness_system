...
<form action = "shangpin.do?method=addCz" method = "post"  enctype = "multipart/form-data"  class="validate" onsubmit="return add();" >
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
				...
				<a href="index/admin/chongzhi/addCz.jsp"><input type="button" class="btn" value="返回"/></a>
			</li>
		</ul>
	</div>
</form>
