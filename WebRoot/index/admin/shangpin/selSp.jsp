...
<body>
<form action="shangpin.do?method=selSp" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">器械管理</a></li>
		<li><a href="#">器械信息查询</a></li>
	</ul>
</div>
...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<table class="imgtable"border = "5" >
			...
			<tr>
				...
				<td>${list.title}</td>
				<td>${list.activityInfo}</td>
				<td>${list.time}</td>
				<td>
					<a href = "shangpin.do?method=showSp&id=${list.id}"><font color="blue">修改</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href = "shangpin.do?method=deleteSp&id=${list.id}" onclick="toAdd()"><font color="blue">删除
					</font></a>
				</td>
	...
	<div class="tools">
		<ul class="toolbar">
			<li class="click"><span><img src="images/t01.png"/></span><a href="index/admin/shangpin/addSp.jsp">添加器械信息</a></li>
		</ul>
		</div>
</div>
</form>
