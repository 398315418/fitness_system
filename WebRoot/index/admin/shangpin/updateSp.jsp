...
<div class="place">
	...
	<ul class="placeul">
		<li><a href="#">器械管理</a></li>
		<li><a href="#">修改器械信息</a></li>
	</ul>
</div>
<form action = "shangpin.do?method=updateSp" method = "post" enctype = "multipart/form-data"  class="validate" onsubmit="return add();" >
	<input name="id" id="xilie"  type="hidden" value="<%=list.get(0).get("id")%>" class="dfinput required" />
	<div class="formbody">
		<div class="formtitle"><span>修改器械信息</span></div>
		<ul class="forminfo">
		<li>
				<label>器械名称</label>
