    ...
    <div class="right">
         <div id="one_top">
            ...
            <div id="one_top_right">
            	<span id="name">服务名称:<%=list.get(0).get("fname") %> </span>&nbsp;&nbsp;&nbsp;
                   
                <br>
                <br>
                 <img src="images/ri.jpg">服务信息
                <img src="images/ri.jpg">数据验证		
                <img src="images/ri.jpg">可以预约		
                <br>
                <br>
            价格：<span style="background-color:#E6E6E6; color:#000000;"><%=list.get(0).get("price") %>（元）</span>
                <br>
                <br>
             描述：<span style="background-color:#E6E6E6; color:#000000;"><%=list.get(0).get("serveInfo") %></span>
                <br>
                <br>
