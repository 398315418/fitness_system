	...
	<script type="text/javascript">
		function showFw(id){
          var d = top.dialog({
                width:800,
                height:330,
                url:'user.do?method=showFw&id='+id,//可以是一个访问路径Action|Servlet等或者jsp页面资源
                onclose: function () {
...
<div id="container" class="container clearfix">
    ...
    <div class="left">
		...
		%>
    <!--right-->
    <form action="user.do?method=selCz" method="post" rel="page">
    <div class="right">
    	<div class="filterbox">	
        ...
        <c:if test="${!empty list}">
			<c:forEach items="${list}" var="list" varStatus="vs">
                    <li class="clearfix">
                    <div class="face"><a href="javascript:void(0);" onclick="showFw('${list.id}');"><img src="<%=basePath %>image/${list.photo}" width="100%" height="100%"  alt=""/></a></div>
                        <div class="text">
                        	<a href="#">课程名：${list.fname} </a>
                        	<p class="zc">价格：${list.price}元</p>
		...
		<c:if test="${empty list}">
			<tr>
				<td colspan="8" align="center">
					<strong><font color="red" size="6">暂时没有课程信息，请重新输入!!!</font></strong>
				</td>
			</tr>
		</c:if>
        </ul>
